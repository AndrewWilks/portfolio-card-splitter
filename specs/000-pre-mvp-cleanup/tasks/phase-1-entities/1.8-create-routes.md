...
- [x] Create `apiCardAccountsList` - GET /api/card-accounts
- [x] Create `apiCardAccountsCreate` - POST /api/card-accounts
- [x] Create `apiCardAccountsGet` - GET /api/card-accounts/:id
- [x] Create `apiCardAccountsUpdate` - PATCH /api/card-accounts/:id
- [x] Create `apiCardAccountsDelete` - DELETE /api/card-accounts/:id

### CardAccountSettings Routes

- [x] Create `apiCardAccountSettingsGet` - GET /api/card-accounts/:id/settings
- [x] Create `apiCardAccountSettingsUpdate` - PATCH /api/card-accounts/:id/settings
- [x] Create `apiCardAccountSettingsReset` - POST /api/card-accounts/:id/settings/reset

### Card Routes

- [x] Create `apiCardsList` - GET /api/cards (with ?cardAccountId= or ?memberId= query)
- [x] Create `apiCardsCreate` - POST /api/cards
- [x] Create `apiCardsGet` - GET /api/cards/:id
- [x] Create `apiCardsUpdate` - PATCH /api/cards/:id
- [x] Create `apiCardsDelete` - DELETE /api/cards/:id

### Integration

- [x] Register all route factories in `backend/di/routes.ts`
- [x] Wire up all routes in `backend/server.ts`
- [x] Create test files for all routes
- [x] Write basic route instantiation tests
