...
Deno.test(
  "PasswordService - hash() should create a valid bcrypt hash",
  async () => {
...
Deno.test(
  "PasswordService - hash() should create different hashes for same password",
  async () => {
    const passwordService = new PasswordService();
    const password = "TestPassword123!";
...
Deno.test(
  "PasswordService - verify() should verify correct password",
  async () => {
    const passwordService = new PasswordService();
    const password = "TestPassword123!";
...
Deno.test(
  "PasswordService - verify() should reject incorrect password",
  async () => {
    const passwordService = new PasswordService();
    const password = "TestPassword123!";
...
Deno.test(
  "PasswordService - verify() should handle invalid hash gracefully",
  async () => {
    const passwordService = new PasswordService();
    const password = "TestPassword123!";
...
Deno.test(
  "PasswordService - validateStrength() should accept valid strong password",
  () => {
    const passwordService = new PasswordService();
...
Deno.test(
  "PasswordService - validateStrength() should reject password too short",
  () => {
    const passwordService = new PasswordService();
...
Deno.test(
  "PasswordService - validateStrength() should reject password without uppercase",
  () => {
    const passwordService = new PasswordService();
...
Deno.test(
  "PasswordService - validateStrength() should reject password without lowercase",
  () => {
    const passwordService = new PasswordService();
...
Deno.test(
  "PasswordService - validateStrength() should reject password without number",
  () => {
    const passwordService = new PasswordService();
...
Deno.test(
  "PasswordService - validateStrength() should reject password without special character",
  () => {
    const passwordService = new PasswordService();
...
Deno.test(
  "PasswordService - getStrengthValidation() should return valid for strong password",
  () => {
    const passwordService = new PasswordService();
...
Deno.test(
  "PasswordService - getStrengthValidation() should return detailed errors",
  () => {
    const passwordService = new PasswordService();
    ...
    assert(
      result.errors.some((e: string) => e.includes("8 characters")),
...
Deno.test(
  "PasswordService - getStrengthValidation() should list all failing requirements",
  () => {
    const passwordService = new PasswordService();
